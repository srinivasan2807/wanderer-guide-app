...
class FPlace: FObject {
    ...
    func getTextPrice() -> NSAttributedString {
        ...
        // attributes
        let prefixAttributes = [NSForegroundColorAttributeName: UIColor(netHex: AppSetting.Color.lightGray), NSFontAttributeName: UIFont(name: AppSetting.Font.roboto, size: 14)!] as [String : Any]
        let textAttributes = [NSForegroundColorAttributeName: UIColor(netHex: AppSetting.Color.black), NSFontAttributeName: UIFont(name: AppSetting.Font.roboto_medium, size: 14)!] as [String : Any]
        // create string
        var hasFrom = false
    ...
    func getDescription_(full: Bool) -> NSAttributedString {
        ...
        let textAttributes = [NSForegroundColorAttributeName: color,
                              NSFontAttributeName: UIFont(name: AppSetting.Font.roboto, size: size)!,
